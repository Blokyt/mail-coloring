...
export const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  { id: 'armed-magic', module: 'Mode arme', title: 'Magique !', description: 'Le mot est colorie ! Double-clic = hotbar + effets armes. Pour desarmer, recliquez sur l\'effet dans le panneau.', targetSelector: '.editor-viewport', position: 'bottom-right', action: 'none' },
